...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      KC_LCTL, KC_LALT, KC_LGUI, EISU,    LOWER,   KC_SPC,  KC_SPC,  KC_BSPC, KC_SPC,  RAISE,   KANA,    KC_RALT, KC_APP , KC_RCTL \
      ),
  ...
  [_COLEMAK] = LAYOUT( \
      ...
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_K,    KC_B,    KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
      KC_LCTL, KC_LALT, KC_LGUI, EISU,    LOWER,   KC_SPC,  KC_SPC,  KC_BSPC, KC_SPC,  RAISE,   KANA,    KC_RALT, KC_APP , KC_RCTL \
      ),
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Shift|   ;  |   Q  |   J  |   K  |   X  |   B  |   X  |   B  |   M  |   W  |   V  |   Z  | Shift|
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Ctrl | Alt  | GUI  | EISU |Lower |Space |Space | Bksp |Space |Raise | KANA | Alt  | App  | Ctrl |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_DVORAK] = LAYOUT( \
      ...
      KC_LSFT, KC_SCLN, KC_Q,    KC_J,    KC_K,    KC_X,    KC_B,    KC_X,    KC_B,    KC_M,    KC_W,    KC_V,    KC_Z,    KC_RSFT, \
      KC_LCTL, KC_LALT, KC_LGUI, EISU,    LOWER,   KC_SPC,  KC_SPC,  KC_BSPC, KC_SPC,  RAISE,   KANA,    KC_RALT, KC_APP , KC_RCTL \
      ),
  ...
  [_LOWER] = LAYOUT( \
      ...
      _______, _______, _______, _______, _______, _______, _______, _______, KC_QUOT, KC_LBRC, KC_RBRC, KC_BSLS, KC_GRV , _______, \
  ...
  [_RAISE] = LAYOUT( \
      ...
      _______, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______,                   KC_HOME, KC_PGUP, KC_PSCR, KC_SLCK, KC_PAUS, _______, \
      KC_CAPS, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______,                   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_BSPC, _______, \
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT( \
      KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                     KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12, \
      _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      KC_6,    KC_7,    KC_8,    KC_9   , KC_0,    KC_EQL, \
      _______, _______, _______, _______, _______, _______,                   KC_QUOT, KC_LBRC, KC_RBRC, KC_BSLS, KC_GRV , _______, \
      _______, _______, _______, _______, _______, _______, _______, KC_DEL,  _______, _______, _______, _______, _______, _______ \
      ),
  ...
  [_RAISE] = LAYOUT( \
      _______, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______,                   KC_HOME, KC_PGUP, KC_PSCR, KC_SLCK, KC_PAUS, _______, \
      KC_CAPS, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______,                   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_BSPC, _______, \
      _______, _______, _______, _______, _______, _______,                   KC_END,  KC_PGDN, KC_DEL,  _______, KC_INS,  _______, \
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ \
      ),
